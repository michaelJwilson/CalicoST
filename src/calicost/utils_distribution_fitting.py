...
class Weighted_NegativeBinomial(GenericLikelihoodModel):
    ...
    def fit(self, start_params=None, maxiter=10_000, maxfun=5_000, **kwds):
        ...
        logger.info(f"Fitting Weighted_NegativeBinom for {self.n_spots} spots and {self.n_states} states.")
        ...
        logger.info(f"Fitted Weighted_NegativeBinom_mix in {run_time:.3f} seconds.")
...
class Weighted_NegativeBinomial_mix(GenericLikelihoodModel):
    ...
    def fit(self, start_params=None, maxiter=10000, maxfun=5000, **kwds):
        ...
        logger.info(f"Fitting Weighted_NegativeBinom_mix for {self.n_spots} spots and {self.n_states} states.")
...
class Weighted_BetaBinom_v1(GenericLikelihoodModel):
    """
...
class Weighted_BetaBinom_mix_v1(GenericLikelihoodModel):
